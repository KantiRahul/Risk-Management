...
module.exports = cds.service.impl(async function() {
    // Define constants for the Risk and BusinessPartner entities fromthe risk-service.cds file
    ...
    // Convert to array, if it's only a single risk, so that thecode won't break here
    const risks = Array.isArray(data) ? data : [data];
    // Looping through the array of risks to set the virtual fieldcriticality' that you defined in the schema
    risks.forEach((risk) => {
...
// )
// ) {
// req.query.SELECT.columns.push({ ref:
// ["bp_BusinessPartner"] });
// }
...
// query:
// SELECT.from(this.entities.BusinessPartners).where({ BusinessPartner:
// bpIDs }),
// headers: {
// apikey: process.env.apikey,
// }
